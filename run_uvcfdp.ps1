...
'-e usb.device_address -e usbvideo.format.numFrameDescriptors -e usbvideo.probe.clockFrequency -e usb.idVendor -e usb.idProduct -E separator=; -Y "usb.transfer_type == 2"'
